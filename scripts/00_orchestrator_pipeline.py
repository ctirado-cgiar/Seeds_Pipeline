...
STEPS = [
    {"id":"01","name":"Obtener Parámetros de Calibración",
     "script":"01_getParameters_chessboard.py","enabled":True,
    ...
    {"id":"02","name":"Corrección de Distorsión",
     "script":"02_distortionCorrection_chessboard.py","enabled":True,"params":{}},
    {"id":"03","name":"Obtener Máscara de Tarjeta de Color",
     "script":"03_getMask_colorCard.py","enabled":True,
    ...
    {"id":"04","name":"Corrección de Color por Máscara",
     "script":"04_colorCorrection_byMask.py","enabled":True,"params":{}},
    {"id":"05","name":"Calibración de Escala",
     "script":"05_setScales.py","enabled":True,"params":{}},
    {"id":"06","name":"Recorte de Área de Interés",
     "script":"06_cutImages_app.py","enabled":False,"params":{}},
    {"id":"07","name":"Aplicar Máscara de Exclusión",
     "script":"07_applyMask_app.py","enabled":False,"params":{}},
    {"id":"08","name":"Análisis de Morfologías",
     "script":"08_morphometricAnalysis.py","enabled":True,
    ...
    {"id":"09","name":"Resumen de Morfometría",
     "script":"09_summarizeMorphometrics.py","enabled":True,"params":{}},
    {"id":"10_0","name":"Extracción de Color por K-means",
     "script":"10.0_extractColor_kmeans.py","enabled":True,
    ...
    {"id":"11_0","name":"Filtrar Binarizadas",
     "script":"11.0_filterBinarized.py","enabled":True,
    ...
    {"id":"12","name":"Distancias de Forma",
     "script":"12_shapesDistance.py","enabled":True,
    ...
    {"id":"14","name":"Clusterización Integrada",
     "script":"14_clusterShape_morphometricIntegrated.py","enabled":True,
    ...
    {"id":"15","name":"Contador de Semillas",
     "script":"15_countSeeds.py","enabled":True,
    ...
    {"id":"16","name":"Unir Datos con Libro de Campo",
     "script":"16_joinData_fieldBook.py","enabled":True,"params":{}},
]
